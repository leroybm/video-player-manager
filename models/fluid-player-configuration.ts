export declare type AdditionalEventInfo = { mediaSourceType: 'ad' | 'source' };
export declare type OnPlay = (event: 'play', callback: (additionalInfo: AdditionalEventInfo) => void) => void;
export declare type OnPlaying =
    (event: 'playing', callback: (event: Event, additionalInfo: AdditionalEventInfo) => void) => void;
export declare type OnPause = (event: 'pause', callback: (additionalInfo: AdditionalEventInfo) => void) => void;
export declare type OnEnded = (event: 'ended', callback: (additionalInfo: AdditionalEventInfo) => void) => void;
export declare type OnSeeked = (event: 'seeked', callback: (additionalInfo: AdditionalEventInfo) => void) => void;
export declare type OnTheaterModeOn =
    (event: 'theatreModeOn', callback: (event: Event, additionalInfo: AdditionalEventInfo) => void) => void;
export declare type OnTheaterModeOff =
    (event: 'theatreModeOff', callback: (event: Event, additionalInfo: AdditionalEventInfo) => void) => void;
export declare type OnTimeUpdate =
    (event: 'timeupdate', callback: (time: number, additionalInfo: AdditionalEventInfo) => void) => void;
export declare type OnMiniPlayerToggle =
    (event: 'miniPlayerToggle', callback: (event: CustomEvent<{
        isToggledOn: boolean
    }>, additionalInfo: AdditionalEventInfo) => void) => void;

export declare interface FluidPlayerInstance {
    play: () => void;
    pause: () => void;
...
export declare interface LayoutControls {
...
export declare interface VTTPreviewOptions {
    file: string;
    type: 'VTT';
...
export declare interface StaticPreviewOptions {
    type: 'static';
    frames: Array<{
        startTime: number;
        endTime: number;
...
export declare interface VastOptions {
...
export declare interface AdOptions {
    vastTag: string;
    roll: string;
...
export declare interface PreRollAdOptions extends AdOptions {
    roll: 'preRoll';
}

export declare interface MidRollAdOptions extends AdOptions {
    roll: 'midRoll';
    timer: number | string;
}

export declare interface PostRollAdOptions extends AdOptions {
    roll: 'postRoll';
}

export declare interface OnPauseRollAdOptions extends AdOptions {
    roll: 'onPauseRoll';
}

export declare interface ModulesOptions {
...
export declare interface FluidPlayerOptions {
