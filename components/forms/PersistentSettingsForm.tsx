  ...
  return (
    <form onSubmit={handleSubmit(onSave)}>
      <FormField
        ...
        errorMessage={errors.playerConfiguration?.layoutControls?.persistentSettings?.volume?.message}
      >
        <CheckboxInput
          register={register}
      ...
      <FormField
        ...
        errorMessage={errors.playerConfiguration?.layoutControls?.persistentSettings?.quality?.message}
      >
        <CheckboxInput
          register={register}
      ...
      <FormField
        ...
        errorMessage={errors.playerConfiguration?.layoutControls?.persistentSettings?.speed?.message}
      >
        <CheckboxInput
          register={register}
      ...
      <FormField
        ...
        errorMessage={errors.playerConfiguration?.layoutControls?.persistentSettings?.theatre?.message}
      >
        <CheckboxInput
          register={register}
